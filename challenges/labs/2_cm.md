...
```
[root@ip-10-65-192-124 centos]# ls /etc/yum.repos.d
CentOS-Base.repo       CentOS-fasttrack.repo
CentOS-Debuginfo.repo  cloudera-manager.repo
CentOS-Media.repo      mysql-community-source.repo
CentOS-Vault.repo      mysql-community.repo

```

## REVOKE & GRANT STATEMENT
...
mysql> grant all on scm.* to `scm`@`ip-10-65-192-124.ec2.internal` identified by 'bc';
Query OK, 0 rows affected (0.00 sec)
